...
def run_tip_adapter_F(cfg, cache_keys, cache_values, test_features, test_labels, clip_model, clipall_model, train_loader_cache, train_loader_F):
...
def main():
    ...
    # ------------------------------------------ Tip-Adapter-F ------------------------------------------
    run_tip_adapter_F(cfg, cache_keys, cache_values, test_features, test_labels, clip_model, clipall_model, train_loader_cache, train_loader_F)
