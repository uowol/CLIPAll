...
if __name__ == "__main__":
    ...
    parser.add_argument("--root", type=str, default="mnt/data4/kchanwo/clipall/datasets/", help="path to dataset")
    parser.add_argument("--output-dir", type=str, default="./jk_test", help="output directory")
    parser.add_argument(
        "--resume",
        type=str,
        default="",
    ...
    parser.add_argument(
        "--seed", type=int, default=2023, help="only positive value enables a fixed seed"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--config-file", type=str, default="/mnt/home/kchanwo/CLIPAll/dassl/configs/trainers/CLIPALL/mom_lr2e-3_B32_ep100.yaml", help="path to config file"
    )
    parser.add_argument(
        "--dataset-config-file",
        type=str,
        default="/mnt/home/kchanwo/CLIPAll/dassl/configs/datasets/imagenet.yaml",
        help="path to config file for dataset setup",
    )
    parser.add_argument("--trainer", type=str, default="CLIPALL", help="name of trainer")
