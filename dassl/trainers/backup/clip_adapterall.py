...
def load_pretrained_model(cfg, model_name='CoOp'):
    ...
    model.load_model(
        f"/data4/kchanwo/clipall/clipall/output/{CUSTOM_DATASETS[cfg.DATASET.NAME]}/CLIP_Adapter/mom_lr35e-3_B4_ep40_16shots/seed1",
        epoch=40) # NOTE!!!
...
class CustomCLIP(nn.Module):
    ...
    def forward(self, image):
        ...
        logits = logit_scale * image_features @ text_features.type(torch.float32).t()

        return logits


@TRAINER_REGISTRY.register()
class CLIP_AdapterALL(TrainerX):
